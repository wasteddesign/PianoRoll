...
namespace Pianoroll.GUI
{
    public class NoteVisual : UIElement
    {
        ...
        protected override void OnRender(DrawingContext dc)
        {
            ...
            double h = Math.Max(1, Note.Length * pd.BeatHeight / Global.TicksPerBeat);
        ...
        {
            editor.pianoroll.NoteClicked(this);
        ...
        protected override void OnMouseMove(System.Windows.Input.MouseEventArgs e)
        {
            ...
            {
                double h = Note.Length * editor.PatDim.BeatHeight / Global.TicksPerBeat;
